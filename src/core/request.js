...
const SYMBOL_ACCEPT = Symbol('Request#accept')
const SYMBOL_BODY = Symbol('Request#body')
const SYMBOL_QUERY = Symbol('Request#query')
...
module.exports = class Request {
    ...
    get accept() {
        if (this[SYMBOL_ACCEPT]) return this[SYMBOL_ACCEPT]
        this[SYMBOL_ACCEPT] = accepts(this.raw)
        return this[SYMBOL_ACCEPT]
    }
    ...
    get subdomains() {
        ...
        if (!hostname) return []
        return (isIP(hostname) ? [hostname] : (hostname).split('.').reverse())
    ...
    get path() {
        return parse(this.raw).pathname
    }
    ...
    get query() {
        ...
        const c = this[SYMBOL_QUERY] = this[SYMBOL_QUERY] || {}
